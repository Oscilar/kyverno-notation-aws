...
replace google.golang.org/grpc v1.73.0 => google.golang.org/grpc v1.79.3

replace go.opentelemetry.io/otel/sdk v1.37.0 => go.opentelemetry.io/otel/sdk v1.43.0

replace go.opentelemetry.io/otel v1.37.0 => go.opentelemetry.io/otel v1.41.0

replace github.com/theupdateframework/go-tuf/v2 v2.0.2 => github.com/theupdateframework/go-tuf/v2 v2.4.1

replace github.com/sigstore/sigstore v1.9.5 => github.com/sigstore/sigstore v1.10.4

replace github.com/sigstore/rekor v1.3.10 => github.com/sigstore/rekor v1.5.0

replace github.com/sigstore/fulcio v1.6.6 => github.com/sigstore/fulcio v1.8.5

replace github.com/sigstore/cosign/v2 v2.4.1 => github.com/sigstore/cosign/v2 v2.6.2

replace github.com/go-jose/go-jose/v3 v3.0.4 => github.com/go-jose/go-jose/v3 v3.0.5

replace github.com/go-jose/go-jose/v4 v4.0.5 => github.com/go-jose/go-jose/v4 v4.1.4

replace github.com/cloudflare/circl v1.6.1 => github.com/cloudflare/circl v1.6.3

replace github.com/Azure/go-ntlmssp v0.0.0-20221128193559-754e69321358 => github.com/Azure/go-ntlmssp v0.1.1

replace filippo.io/edwards25519 v1.1.0 => filippo.io/edwards25519 v1.1.1

replace github.com/sigstore/timestamp-authority/v2 v2.0.3 => github.com/sigstore/timestamp-authority/v2 v2.0.6

replace github.com/in-toto/in-toto-golang v0.9.1-0.20240317085821-8e2966059a09 => github.com/in-toto/in-toto-golang v0.11.0
